...
export declare type AmmProgram = Program<AmmIdl>;
export declare type VaultProgram = Program<VaultIdl>;
...
export declare type CurveType = ConstantProductCurve | StableSwapCurve;
...
export declare type PoolType = PermissionedType | PermissionedlessType;
export declare type PermissionedType = {
    Permissioned: {};
};
export declare type PermissionedlessType = {
    Permissionless: {};
};
export declare type PoolState = Omit<IdlAccounts<AmmIdl>['pool'], 'curveType' | 'fees' | 'poolType'> & {
    curveType: CurveType;
    fees: PoolFees;
    poolType: PoolType;
};
export declare type Depeg = Omit<IdlTypes<AmmIdl>['Depeg'], 'depegType'> & {
    depegType: DepegType;
};
export declare type PoolFees = IdlTypes<AmmIdl>['PoolFees'];
