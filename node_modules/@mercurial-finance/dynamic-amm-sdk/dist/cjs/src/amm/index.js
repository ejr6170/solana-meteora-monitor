...
const getAllPoolState = (poolMints, program) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return poolStates.map((poolState, idx) => {
        ...
        const lpSupply = new anchor_1.BN(spl_token_1.u64.fromBuffer(spl_token_1.MintLayout.decode(lpMintAccount.data).supply));
...
const decodeAccountTypeMapper = (type) => {
    const decoder = {
        [types_1.AccountType.VAULT_A_RESERVE]: (accountData) => new anchor_1.BN(spl_token_1.u64.fromBuffer(spl_token_1.AccountLayout.decode(accountData).amount)),
        [types_1.AccountType.VAULT_B_RESERVE]: (accountData) => new anchor_1.BN(spl_token_1.u64.fromBuffer(spl_token_1.AccountLayout.decode(accountData).amount)),
        [types_1.AccountType.VAULT_A_LP]: (accountData) => new anchor_1.BN(spl_token_1.u64.fromBuffer(spl_token_1.MintLayout.decode(accountData).supply)),
        [types_1.AccountType.VAULT_B_LP]: (accountData) => new anchor_1.BN(spl_token_1.u64.fromBuffer(spl_token_1.MintLayout.decode(accountData).supply)),
        [types_1.AccountType.POOL_VAULT_A_LP]: (accountData) => new anchor_1.BN(spl_token_1.u64.fromBuffer(spl_token_1.AccountLayout.decode(accountData).amount)),
        [types_1.AccountType.POOL_VAULT_B_LP]: (accountData) => new anchor_1.BN(spl_token_1.u64.fromBuffer(spl_token_1.AccountLayout.decode(accountData).amount)),
        [types_1.AccountType.POOL_LP_MINT]: (accountData) => new anchor_1.BN(spl_token_1.u64.fromBuffer(spl_token_1.MintLayout.decode(accountData).supply)),
...
const getAccountsBuffer = (connection, accountsToFetch) => __awaiter(void 0, void 0, void 0, function* () {
    const accounts = yield (0, utils_1.chunkedGetMultipleAccountInfos)(connection, accountsToFetch.map((account) => account.pubkey));
...
class AmmImpl {
    ...
    static createPermissionlessPool(connection, payer, tokenInfoA, tokenInfoB, tokenAAmount, tokenBAmount, isStable, opt) {
        return __awaiter(this, void 0, void 0, function* () {
            const { vaultProgram, ammProgram } = (0, utils_1.createProgram)(connection, opt === null || opt === void 0 ? void 0 : opt.programId);
            ...
            if (!aVaultAccount) {
                const createVaultAIx = yield vault_sdk_1.default.createPermissionlessVaultInstruction(connection, payer, tokenInfoA);
            ...
            if (!bVaultAccount) {
                const createVaultBIx = yield vault_sdk_1.default.createPermissionlessVaultInstruction(connection, payer, tokenInfoB);
                createVaultBIx && preInstructions.push(createVaultBIx);
            }
            else {
                bVaultLpMint = bVaultAccount.lpMint; // Old vault doesn't have lp mint pda
            }
            const poolPubkey = (0, utils_1.derivePoolAddress)(connection, tokenInfoA, tokenInfoB, isStable, {
            ...
            const payerPoolLp = yield (0, utils_1.getAssociatedTokenAccount)(lpMint, payer);
            if (tokenInfoA.address === constants_1.WRAPPED_SOL_MINT.toBase58()) {
                preInstructions = preInstructions.concat((0, utils_1.wrapSOLInstruction)(payer, payerTokenA, BigInt(tokenAAmount.toString())));
            }
            if (tokenInfoB.address === constants_1.WRAPPED_SOL_MINT.toBase58()) {
            ...
            const createPermissionlessPoolTx = yield ammProgram.methods
                ...
                .transaction();
            return new web3_js_1.Transaction(Object.assign({ feePayer: payer }, (yield ammProgram.provider.connection.getLatestBlockhash('finalized')))).add(createPermissionlessPoolTx);
        });
    }
    static createMultiple(connection, poolList, opt) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const vaultsImpl = yield vault_sdk_1.default.createMultiple(connection, tokenInfos);
            const accountsToFetch = yield Promise.all(poolsState.map((poolState, index) => __awaiter(this, void 0, void 0, function* () {
                ...
                (0, invariant_1.default)(tokenInfoA, `TokenInfo ${poolState.tokenAMint.toBase58()} not found`);
                (0, invariant_1.default)(tokenInfoB, `TokenInfo ${poolState.tokenBMint.toBase58()} not found`);
            ...
            const ammImpls = yield Promise.all(accountsToFetch.map((accounts) => __awaiter(this, void 0, void 0, function* () {
                ...
                const currentTime = accountsInfoMap.get(web3_js_1.SYSVAR_CLOCK_PUBKEY.toBase58());
    ...
    static create(connection, pool, tokenInfoA, tokenInfoB, opt) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const cluster = (_a = opt === null || opt === void 0 ? void 0 : opt.cluster) !== null && _a !== void 0 ? _a : 'mainnet-beta';
            const { provider, vaultProgram, ammProgram } = (0, utils_1.createProgram)(connection, opt === null || opt === void 0 ? void 0 : opt.programId);
            ...
            const [vaultA, vaultB] = yield Promise.all([
                vault_sdk_1.default.create(provider.connection, tokenInfoA, { cluster, seedBaseKey: opt === null || opt === void 0 ? void 0 : opt.vaultSeedBaseKey }),
                vault_sdk_1.default.create(provider.connection, tokenInfoB, { cluster, seedBaseKey: opt === null || opt === void 0 ? void 0 : opt.vaultSeedBaseKey }),
            ]);
            const accountsBufferMap = yield getAccountsBuffer(connection, [
                { pubkey: vaultA.vaultState.tokenVault, type: types_1.AccountType.VAULT_A_RESERVE },
                { pubkey: vaultB.vaultState.tokenVault, type: types_1.AccountType.VAULT_B_RESERVE },
    ...
    updateState() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.isStablePool) {
                // update swap curve
                const { amp, depeg, tokenMultiplier } = poolState.curveType['stable'];
                this.swapCurve = new curve_1.StableSwap(amp.toNumber(), tokenMultiplier, depeg, this.depegAccounts, currentTime);
            }
            const poolInfo = (0, utils_1.calculatePoolInfo)(currentTime, poolVaultALp, poolVaultBLp, vaultALpSupply, vaultBLpSupply, poolLpSupply, this.swapCurve, this.vaultA.vaultState, this.vaultB.vaultState);
    ...
    getUserBalance(owner) {
        return __awaiter(this, void 0, void 0, function* () {
            const account = yield (0, utils_1.getAssociatedTokenAccount)(this.poolState.lpMint, owner, this.opt.allowOwnerOffCurve);
            if (!account)
                return new anchor_1.BN(0);
    ...
    swap(owner, inTokenMint, inAmountLamport, outAmountLamport) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (constants_1.WRAPPED_SOL_MINT.equals(destinationToken)) {
                const unwrapSOLIx = yield (0, utils_1.unwrapSOLInstruction)(owner, this.opt.allowOwnerOffCurve);
    ...
    deposit(owner, tokenAInAmount, tokenBInAmount, poolTokenAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ([this.tokenA.address, this.tokenB.address].includes(constants_1.WRAPPED_SOL_MINT.toBase58())) {
                const closeWrappedSOLIx = yield (0, utils_1.unwrapSOLInstruction)(owner, this.opt.allowOwnerOffCurve);
    ...
    withdraw(owner, lpTokenAmount, tokenAOutAmount, tokenBOutAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [[userAToken, createUserAIx], [userBToken, createUserBIx], [userPoolLp, createLpTokenIx]] = yield Promise.all([this.poolState.tokenAMint, this.poolState.tokenBMint, this.poolState.lpMint].map((key) => (0, utils_1.getOrCreateATAInstruction)(key, owner, this.program.provider.connection, this.opt.allowOwnerOffCurve)));
    ...
    createATAPreInstructions(owner, mintList) {
        return __awaiter(this, void 0, void 0, function* () {
            return Promise.all(mintList.map((mint) => {
                return (0, utils_1.getOrCreateATAInstruction)(mint, owner, this.program.provider.connection, this.opt.allowOwnerOffCurve);
            }));
        });
    }
