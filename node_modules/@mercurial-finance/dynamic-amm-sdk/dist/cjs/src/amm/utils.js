...
exports.generateCurveType = exports.DepegType = exports.getFirstKey = exports.getSecondKey = exports.encodeCurveType = exports.chunkedGetMultipleAccountInfos = exports.chunks = exports.checkPoolExists = exports.derivePoolAddress = exports.getTokensMintFromPoolAddress = exports.computeTokenMultiplier = exports.calculateSwapQuote = exports.getDepegAccounts = exports.calculateMaxSwapOutAmount = exports.calculateTradingFee = exports.calculateAdminTradingFee = exports.calculatePoolInfo = exports.computeActualDepositAmount = exports.getOnchainTime = exports.deserializeAccount = exports.unwrapSOLInstruction = exports.wrapSOLInstruction = exports.getOrCreateATAInstruction = exports.getAssociatedTokenAccount = exports.getMinAmountWithSlippage = exports.getMaxAmountWithSlippage = exports.createProgram = void 0;
...
const createProgram = (connection, programId) => {
    ...
    const ammProgram = new anchor_1.Program(idl_1.IDL, programId !== null && programId !== void 0 ? programId : constants_1.PROGRAM_ID, provider);
...
const getOrCreateATAInstruction = (tokenMint, owner, connection, allowOwnerOffCurve) => __awaiter(void 0, void 0, void 0, function* () {
    let toAccount;
    try {
        toAccount = yield spl_token_1.Token.getAssociatedTokenAddress(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, tokenMint, owner, allowOwnerOffCurve !== null && allowOwnerOffCurve !== void 0 ? allowOwnerOffCurve : false);
...
const unwrapSOLInstruction = (owner, allowOwnerOffCurve) => __awaiter(void 0, void 0, void 0, function* () {
    const wSolATAAccount = yield spl_token_1.Token.getAssociatedTokenAddress(spl_token_1.ASSOCIATED_TOKEN_PROGRAM_ID, spl_token_1.TOKEN_PROGRAM_ID, constants_1.WRAPPED_SOL_MINT, owner, allowOwnerOffCurve !== null && allowOwnerOffCurve !== void 0 ? allowOwnerOffCurve : false);
    if (wSolATAAccount) {
...
const calculatePoolInfo = (currentTimestamp, poolVaultALp, poolVaultBLp, vaultALpSupply, vaultBLpSupply, poolLpSupply, swapCurve, vaultA, vaultB) => {
    ...
    const virtualPrice = virtualPriceBigNum.toNumber() / constants_1.VIRTUAL_PRICE_PRECISION.toNumber();
...
const calculateSwapQuote = (inTokenMint, inAmountLamport, params) => {
    ...
    if ('stable' in poolState.curveType) {
        ...
        swapCurve = new curve_1.StableSwap(amp.toNumber(), tokenMultiplier, depeg, depegAccounts, new anchor_1.BN(currentTime));
    }
    else {
...
const computeTokenMultiplier = (decimalA, decimalB) => {
    ...
    const tokenAMultiplier = new anchor_1.BN(Math.pow(10, (precisionFactor - decimalA)));
    const tokenBMultiplier = new anchor_1.BN(Math.pow(10, (precisionFactor - decimalB)));
    return {
        tokenAMultiplier,
        tokenBMultiplier,
        precisionFactor,
...
function getTokensMintFromPoolAddress(connection, poolAddress, opt) {
    return __awaiter(this, void 0, void 0, function* () {
        const { ammProgram } = (0, exports.createProgram)(connection, opt === null || opt === void 0 ? void 0 : opt.programId);
        const poolAccount = yield ammProgram.account.pool.fetchNullable(new web3_js_1.PublicKey(poolAddress));
        if (!poolAccount)
            return;
        return {
...
function derivePoolAddress(connection, tokenInfoA, tokenInfoB, isStable, opt) {
    const { ammProgram } = (0, exports.createProgram)(connection, opt === null || opt === void 0 ? void 0 : opt.programId);
 ...
 */
function checkPoolExists(connection, tokenInfoA, tokenInfoB, isStable, opt) {
    return __awaiter(this, void 0, void 0, function* () {
        const { ammProgram } = (0, exports.createProgram)(connection, opt === null || opt === void 0 ? void 0 : opt.programId);
        const curveType = generateCurveType(tokenInfoA, tokenInfoB, isStable);
        const tokenAMint = new web3_js_1.PublicKey(tokenInfoA.address);
