...
import { TOKEN_PROGRAM_ID, AccountLayout, getMint } from 'spl2';
...
const dexDevnetProgramKey = new PublicKey("DESVgJVGajEgKGXhb6XmqDHGz3VjdgP7rEVESBgxmroY");
const dexMainnetProgramKey = new PublicKey("9xQeWvG816bUx9EPjHmaT23yvVM2ZWbrrpZb9PusVFin");
const psyLendDevnetProgramKey = new PublicKey("8bpiM4yhcLYMSeCBTVFWisneXPQQWPYSA5ZpMm4DKAgT");
const psyLendMainnetProgramKey = new PublicKey("PLENDj46Y4hhqitNV2WqLqGLrWKAaH2xJHm2UyHgJLY");
const psyFiDevnetProgramKey = new PublicKey("95q3X9ADJv5hWt93oSaPqABPnP1rqfmjgrnto9v83LPK");
const psyFiMainnetProgramKey = new PublicKey("PSYFiYqguvMXwpDooGdYV6mju92YEbFobbvW617VNcq");
/**
 * On all networks (devnet, local, main)
 */
const euroPrimitiveProgramKey = new PublicKey("FASQhaZQT53W9eT9wWnPoBFw8xzZDey9TbMmJj6jCQTs");
...
const deriveReserveAccounts = (program, reserveAddress, tokenMint) => __awaiter(void 0, void 0, void 0, function* () {
    let accounts = {
        ...
        feeNoteVault: PublicKey.default,
        dexOpenOrders: PublicKey.default,
        dexSwapTokens: PublicKey.default,
    ...
    [accounts.feeNoteVault, bumpSeeds.feeNoteVault] =
        yield PublicKey.findProgramAddress([Buffer.from("fee-vault"), reserveAddress.toBytes()], program.programId);
    [accounts.dexSwapTokens, bumpSeeds.dexSwapTokens] =
        yield PublicKey.findProgramAddress([Buffer.from("dex-swap-tokens"), reserveAddress.toBytes()], program.programId);
    [accounts.dexOpenOrders, bumpSeeds.dexOpenOrders] =
        yield PublicKey.findProgramAddress([Buffer.from("dex-open-orders"), reserveAddress.toBytes()], program.programId);
    [accounts.loanNoteMint, bumpSeeds.loanNoteMint] =
        yield PublicKey.findProgramAddress([Buffer.from("loans"), reserveAddress.toBytes(), tokenMint.toBytes()], program.programId);
...
const deriveReserveAccountsSync = (programId, reserveAddress, tokenMint) => {
    ...
    [accounts.feeNoteVault, bumpSeeds.feeNoteVault] =
        PublicKey.findProgramAddressSync([Buffer.from("fee-vault"), reserveAddress.toBytes()], programId);
    [accounts.dexSwapTokens, bumpSeeds.dexSwapTokens] =
        PublicKey.findProgramAddressSync([Buffer.from("dex-swap-tokens"), reserveAddress.toBytes()], programId);
    [accounts.dexOpenOrders, bumpSeeds.dexOpenOrders] =
        PublicKey.findProgramAddressSync([Buffer.from("dex-open-orders"), reserveAddress.toBytes()], programId);
    [accounts.loanNoteMint, bumpSeeds.loanNoteMint] =
        PublicKey.findProgramAddressSync([Buffer.from("loans"), reserveAddress.toBytes(), tokenMint.toBytes()], programId);
    [accounts.depositNoteMint, bumpSeeds.depositNoteMint] =
...
const deriveDepositNoteMint = (programId, reserveAddress, tokenMint) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([Buffer.from("deposits"), reserveAddress.toBytes(), tokenMint.toBytes()], programId);
});
const deriveDepositNoteMintSync = (programId, reserveAddress, tokenMint) => {
    return PublicKey.findProgramAddressSync([Buffer.from("deposits"), reserveAddress.toBytes(), tokenMint.toBytes()], programId);
};
const deriveUserDeposits = (programId, reserveAddress, userAddress) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([Buffer.from("deposits"), reserveAddress.toBytes(), userAddress.toBytes()], programId);
});
const deriveUserDepositsSync = (programId, reserveAddress, userAddress) => {
    return PublicKey.findProgramAddressSync([Buffer.from("deposits"), reserveAddress.toBytes(), userAddress.toBytes()], programId);
};
...
const deriveClientReserveAccountsAlt = (programId, reserveAddress, obligationAddress, userAddress) => __awaiter(void 0, void 0, void 0, function* () {
    let accounts = {
        deposits: PublicKey.default,
        loan: PublicKey.default,
        collateral: PublicKey.default,
    };
    let bumpSeeds = {
        deposits: 0,
        loan: 0,
...
const deriveUserObligationAlt = (programId, marketAddress, userAddress) => __awaiter(void 0, void 0, void 0, function* () {
    let [obligationAccount, obligationBump] = yield PublicKey.findProgramAddress([
...
const deriveUserObligationSync = (programId, marketAddress, userAddress) => __awaiter(void 0, void 0, void 0, function* () {
    let [obligationAccount, obligationBump] = PublicKey.findProgramAddressSync([
        Buffer.from("obligation"),
        marketAddress.toBytes(),
        userAddress.toBytes(),
    ], programId);
...
const deriveMarketAuthority = (program, market) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([market.toBytes()], program.programId);
});
/**
...
const deriveMarketAuthorityAlt = (programId, market) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([market.toBytes()], programId);
});
const deriveMarketAuthoritySync = (programId, market) => __awaiter(void 0, void 0, void 0, function* () {
    return PublicKey.findProgramAddressSync([market.toBytes()], programId);
});
const deriveReserveVault = (programId, reserveAddress) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([Buffer.from("vault"), reserveAddress.toBytes()], programId);
});
const deriveReserveVaultSync = (programId, reserveAddress) => {
    return PublicKey.findProgramAddressSync([Buffer.from("vault"), reserveAddress.toBytes()], programId);
};
const deriveDiscounts = (program) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([Buffer.from("discounts")], program.programId);
});
const deriveDiscountsAlt = (programId) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([Buffer.from("discounts")], programId);
});
const deriveDiscountsSync = (programId) => {
    return PublicKey.findProgramAddressSync([Buffer.from("discounts")], programId);
};
const deriveRewardTokenAccount = (program, marketRewardAddress, stateIndex, rewardTokenMint) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([
        ...
        new BN(stateIndex).toArrayLike(Buffer, "le", 1),
...
const syncDiscountRates = (program, reserve) => __awaiter(void 0, void 0, void 0, function* () {
    let [discountsKey] = PublicKey.findProgramAddressSync([Buffer.from("discounts")], program.programId);
    const ix = program.methods
        .syncDiscountRates()
        .accounts({
        reserve: reserve,
...
const decodePositionStruct = (buff) => {
    let a = {
        account: new PublicKey(buff.slice(0, 0 + 32)),
        noteAmount: new BN(buff.slice(32, 32 + 24), undefined, "le"),
        lastUpdated: new BN(buff.slice(56, 56 + 8), undefined, "le"),
        cummulativeRewardUnits: new BN(buff.slice(64, 64 + 16), undefined, "le"),
        // side: Number(buff.slice(80, 80 + 4)),
        // reserveIndex: Number(buff.slice(84, 84 + 2)),
        side: new BN(buff.slice(80, 80 + 4), undefined, "le"),
        reserveIndex: new BN(buff.slice(84, 84 + 2), undefined, "le"),
    };
    return a;
};
/**
...
const decodePositionsList = (buff, loadAll = true) => {
    ...
    while (start < MAX_POSITION_PER_SIDE * POSITION_SIZE$1) {
        ...
        if (loadAll || !position.account.equals(PublicKey.default)) {
...
const decodeCalculationCacheInner = (buff) => {
    let a = {
        collateralValue: new BN(buff.slice(0, 0 + 24), undefined, "le"),
        discountedCollateralValue: new BN(buff.slice(24, 24 + 24), undefined, "le"),
        loanValue: new BN(buff.slice(48, 48 + 24), undefined, "le"),
    };
    return a;
};
/**
...
const decodeCalculationCacheStruct = (buff) => {
    let a = {
        collateral_value: new BN(buff.slice(0, 0 + 24), undefined, "le"),
        discounted_collateral_value: new BN(buff.slice(24, 24 + 24), undefined, "le"),
        loan_value: new BN(buff.slice(48, 48 + 24), undefined, "le"),
        _reserved: [],
        //Reserved is 168 bytes...
        lastUpdated: new BN(buff.slice(24 + 168, 24 + 168 + 8), undefined, "le"),
        // 1 = true, 0 false
...
const decodeU128Array = (buff, start, length) => {
    ...
    for (let i = 0; i < length; i++) {
        decodedData.push(new BN(buff.slice(sliceStart, sliceStart + 16), undefined, "le"));
        sliceStart += 16;
    }
    return decodedData;
};
...
const decodeReserveInfoStruct = (buff) => {
    let a = {
        reserve: new PublicKey(buff.slice(0, 0 + 32)),
        price: new BN(buff.slice(112, 112 + 24), undefined, "le"),
        minCollateralRatio: new BN(buff.slice(136, 136 + 24), undefined, "le"),
        liquidationBonus: new BN(buff.slice(160, 160 + 2), undefined, "le"),
        discountRate: new BN(buff.slice(162, 162 + 2), undefined, "le"),
        reserveInfoLastUpdated: new BN(buff.slice(288, 288 + 8), undefined, "le"),
        reserveInfoInvalidated: Number(buff.slice(296, 296 + 1)),
        depositNoteExchangeRate: new BN(buff.slice(304, 304 + 24), undefined, "le"),
        loanNoteExchangeRate: new BN(buff.slice(328, 328 + 24), undefined, "le"),
        noteInfoLastUpdated: new BN(buff.slice(480, 480 + 8), undefined, "le"),
...
const getOrInitUserDepositAccount = (program, depositKey, bump = 0, toCreate) => __awaiter(void 0, void 0, void 0, function* () {
    if (depositKey.equals(PublicKey.default)) {
    ...
    yield program.provider.sendAndConfirm(new Transaction().add(ix));
    return depositKey;
});
/**
...
const getOrInitCollateralAccount = (program, accountKey, bump = 0, toCreate) => __awaiter(void 0, void 0, void 0, function* () {
    if (accountKey.equals(PublicKey.default)) {
        console.error("Passed the default pubkey, must derive the correct deposit key before calling this function.");
    }
 ...
 */
const createAndInitMarketReward = (program, marketRewardKeypair, psyMarket, psyMarketOwner, initialRewardIndexTimestamp, distributionPeriod, rewardPointsPerPeriod, rewardUnitDecimals, minWithdrawalDuration = new BN(0)) => __awaiter(void 0, void 0, void 0, function* () {
    let tx = new Transaction();
    tx.add(SystemProgram.createAccount({
...
const readU192FromBuffer = (buff, start) => {
    return new BN(buff.slice(start, start + 24), undefined, "le");
};
/**
...
const getMintSupply = (connection, mint) => __awaiter(void 0, void 0, void 0, function* () {
    return (yield getMint(connection, mint)).supply;
});
...
const getNoteExchangeRatesForReserve = (reserve) => {
    ...
    let loanTokenSupply = reserveState.outstandingDebt.div(new BN(Math.pow(10, 15)));
...
const psyBNToNumber = (psyNumber) => {
    ...
    if (psyNumber.lt(new BN(numberMax))) {
...
class EcosystemHelper {
    ...
    refreshVault(reserveKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (vaultKey.equals(PublicKey.default)) {
    ...
    parsePriceDataIntoPriceInformation(reserveKey, buff, nativeDecimals) {
        var _a;
        let priceData = parsePriceData(buff);
    ...
    isPsyfiReserve(reserveKey) {
        ...
        return !((_a = this.getReserveInfo(reserveKey)) === null || _a === void 0 ? void 0 : _a.psyfiVaultConfig.vaultAccount.equals(PublicKey.default));
    }
}
...
const obligationLoaderNoFetch = (userObligation) => {
    ...
    for (let i = 0; i < collateralBytes.length; i += POSITION_SIZE) {
        ...
        let reserveKey = new PublicKey(keyBytes);
...
export { IDL, IDL as PsyLendIdl, ecosystem_helper as ecosystemHelper, instructions, keys, liquidation_utils as liquidationUtils, math, pdas, tools, types };
