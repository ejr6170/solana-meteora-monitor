...
import { CURVE_TYPE_ACCOUNTS, ERROR, WRAPPED_SOL_MINT, PROGRAM_ID, VIRTUAL_PRICE_PRECISION, PERMISSIONLESS_AMP, } from './constants';
...
export function derivePoolAddress(connection, tokenInfoA, tokenInfoB, isStable, opt) {
    const { ammProgram } = createProgram(connection, opt === null || opt === void 0 ? void 0 : opt.programId);
 ...
 */
export function checkPoolExists(connection, tokenInfoA, tokenInfoB, isStable, opt) {
    return __awaiter(this, void 0, void 0, function* () {
        const { ammProgram } = createProgram(connection, opt === null || opt === void 0 ? void 0 : opt.programId);
        const curveType = generateCurveType(tokenInfoA, tokenInfoB, isStable);
        const tokenAMint = new PublicKey(tokenInfoA.address);
