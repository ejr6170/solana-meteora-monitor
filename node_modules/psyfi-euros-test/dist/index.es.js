...
import { Token, ASSOCIATED_TOKEN_PROGRAM_ID, TOKEN_PROGRAM_ID, NATIVE_MINT } from '@solana/spl-token';
import { PROGRAM_ID } from '@metaplex-foundation/mpl-token-metadata';
import { pdas as pdas$1 } from 'psystake-test';
...
const deriveUnderlyingPoolKey = (underlyingMint) => PublicKey.findProgramAddress([underlyingMint.toBuffer(), Buffer.from("underlyingPool")], euroPrimitiveProgramKey);
const deriveStablePoolKey = (stableMint) => PublicKey.findProgramAddress([stableMint.toBuffer(), Buffer.from("stablePool")], euroPrimitiveProgramKey);
const deriveCallOptionMint = (euroMetaKey) => PublicKey.findProgramAddress([euroMetaKey.toBuffer(), Buffer.from("callOptionMint")], euroPrimitiveProgramKey);
const deriveCallWriterMint = (euroMetaKey) => PublicKey.findProgramAddress([euroMetaKey.toBuffer(), Buffer.from("callWriterMint")], euroPrimitiveProgramKey);
const derivePutOptionMint = (euroMetaKey) => PublicKey.findProgramAddress([euroMetaKey.toBuffer(), Buffer.from("putOptionMint")], euroPrimitiveProgramKey);
const derivePutWriterMint = (euroMetaKey) => PublicKey.findProgramAddress([euroMetaKey.toBuffer(), Buffer.from("putWriterMint")], euroPrimitiveProgramKey);
const derivePoolAuthority = () => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([Buffer.from("poolAuthority")], euroPrimitiveProgramKey);
});
const deriveVaultAccount = (program, collateralAssetMint, quoteAssetMint, uniqueSeed, strategyType) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([
        ...
        new BN(strategyType).toArrayLike(Buffer, "le", 1),
        new BN(uniqueSeed).toArrayLike(Buffer, "le", 2),
    ], program.programId);
});
...
const deriveVaultAuthority = (program, vaultAccount) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([vaultAccount.toBuffer(), Buffer.from("VaultAuthority")], program.programId);
});
const deriveVaultCollateralAccount = (program, vaultAccount) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([vaultAccount.toBuffer(), Buffer.from("VaultCollateralAccount")], program.programId);
});
const deriveVaultTokenMint = (program, vaultAccount) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([vaultAccount.toBuffer(), Buffer.from("VaultTokenMint")], program.programId);
});
const deriveVaultTokenAccount = (program, vaultAccount) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([vaultAccount.toBuffer(), Buffer.from("VaultTokenAccount")], program.programId);
});
const deriveWithdrawalCollateralAccount = (program, vaultAccount) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([vaultAccount.toBuffer(), Buffer.from("WithdrawalCollateralAccount")], program.programId);
});
...
const deriveRequestQueue = (optionMintKey, priceCurrencyKey) => PublicKey.findProgramAddress([
    optionMintKey.toBuffer(),
    priceCurrencyKey.toBuffer(),
    Buffer.from("requestQueue"),
], euroPrimitiveProgramKey);
const deriveCoinVault = (optionMintKey, priceCurrencyKey) => PublicKey.findProgramAddress([
    optionMintKey.toBuffer(),
    priceCurrencyKey.toBuffer(),
    Buffer.from("coinVault"),
], euroPrimitiveProgramKey);
const derivePCVault = (optionMintKey, priceCurrencyKey) => PublicKey.findProgramAddress([
    optionMintKey.toBuffer(),
    priceCurrencyKey.toBuffer(),
    Buffer.from("pcVault"),
], euroPrimitiveProgramKey);
const deriveSerumMarketAddress = (optionMintKey, priceCurrencyKey) => PublicKey.findProgramAddress([
    optionMintKey.toBuffer(),
    priceCurrencyKey.toBuffer(),
...
const deriveSerumVaultOwner = (serumMarket, serumDexProgramKey) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    while (nonce.toNumber() < 255) {
        try {
            const vaultOwner = yield PublicKey.createProgramAddress([serumMarket.toBuffer(), nonce.toArrayLike(Buffer, "le", 8)], serumDexProgramKey);
...
const deriveStagingAccount = (auctionCurrencyMint, vaultAccount) => __awaiter(void 0, void 0, void 0, function* () {
    const stagingAccount = yield Token.getAssociatedTokenAddress(ASSOCIATED_TOKEN_PROGRAM_ID, TOKEN_PROGRAM_ID, auctionCurrencyMint, vaultAccount, true);
    return stagingAccount;
});
const deriveMetadataAccount = (mint) => __awaiter(void 0, void 0, void 0, function* () {
    const [metadataAccount] = yield PublicKey.findProgramAddress([Buffer.from("metadata"), PROGRAM_ID.toBuffer(), mint.toBuffer()], PROGRAM_ID);
...
const settleSerumOrderRpc = (program, epochNumber, vaultAccount, optionTokenAccount, euroMeta, optionMint, referralAccount, auctionCurrencyMint, serumDexProgramKey, signers) => __awaiter(void 0, void 0, void 0, function* () {
    const stagingAccount = yield deriveStagingAccount(auctionCurrencyMint, vaultAccount);
    const tx = new Transaction().add(Token.createAssociatedTokenAccountInstruction(ASSOCIATED_TOKEN_PROGRAM_ID, TOKEN_PROGRAM_ID, auctionCurrencyMint, stagingAccount, vaultAccount, program.provider.wallet.publicKey));
    try {
...
const getMethodBuilder$6 = (program, stakingProgramKey, receiptEpoch, userAuthority, vaultAccount, stakePool, receivingTokenAccount, startRewardRecordEpoch, endRewardRecordEpoch, rewardPoolId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [vaultOwnershipTokenMint] = yield deriveVaultTokenMint(program, vaultAccount);
    const [stakingRecord] = yield pdas$1.deriveStakingRecord(stakingProgramKey, userAuthority, stakePool);
    const [rewardPool] = yield pdas$1.deriveRewardPool(stakingProgramKey, stakePool, rewardPoolId);
    const [startRewardRecord] = yield pdas$1.deriveRewardRecord(stakingProgramKey, rewardPool, startRewardRecordEpoch);
    const [endRewardRecord] = yield pdas$1.deriveRewardRecord(stakingProgramKey, rewardPool, endRewardRecordEpoch);
    const [allocatedTokenAccount] = yield pdas$1.deriveAllocatedTokenAccount(stakingProgramKey, rewardPool);
...
const getMethodBuilder$5 = (program, stakingProgramKey, feeReceiver, receiptEpoch, userAuthority, vaultAccount, stakePool) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const [vaultOwnershipTokenMint] = yield deriveVaultTokenMint(program, vaultAccount);
    const [stakingRecord] = yield pdas$1.deriveStakingRecord(stakingProgramKey, userAuthority, stakePool);
    const [stakingTokenAccount] = yield pdas$1.deriveStakingTokenAccount(stakingProgramKey, stakePool);
...
export { PsyFiIdl, StrategyType, dexDevnetProgramKey, dexMainnetProgramKey, euroPrimitiveProgramKey, index as instructions, pdas };
