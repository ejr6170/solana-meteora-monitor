...
const deriveStakingTokenAccount = (programId, stakePool) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([stakePool.toBuffer(), Buffer.from("StakingTokenPool")], programId);
});
...
const deriveRewardTokenAccount = (programId, rewardPool) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([rewardPool.toBuffer(), Buffer.from("RewardTokenAccount")], programId);
});
const deriveAllocatedTokenAccount = (programId, rewardPool) => __awaiter(void 0, void 0, void 0, function* () {
    return yield PublicKey.findProgramAddress([rewardPool.toBuffer(), Buffer.from("AllocatedTokenAccount")], programId);
});
...
const calculateRewardUnits = (stakedAmount, lockUpPeriod) => {
    ...
    return stakedAmount.mul(new BN(rewardMultiplier)).div(divisor);
};
...
export { DistributionType, IDL, calculateRewardUnits, convertDistributionType, index as instructions, pdas };
